...
export const FORCE_TECHNIQUE_WEAPON_UP = characterClassAddon(
...
export const FORCE_NATURAL_PP_RECOVERY = characterClassAddon(
...
export const FORCE_PANIC_RES_UP = characterClassAddon(
