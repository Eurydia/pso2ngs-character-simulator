...
export const TECHTER_NATURAL_PB_RECOVERY = characterClassAddon(
...
export const TECHTER_DAMAGE_RES_UP = characterClassAddon(
...
export const TECHTER_POISON_RES_UP = characterClassAddon(
