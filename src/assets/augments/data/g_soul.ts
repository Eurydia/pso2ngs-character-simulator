...
(() => {
  ...
  DATA_BP.forEach((bp, level_index) => {
    ...
    const soul_augment: Augment = makeAugmentSoul("Alt Soul", level, {
      [StatEnum.CORE_BP]: bp,
      [StatEnum.CORE_HP]: hp,
...
(() => {
  ...
  for (const entry of DATA_ENTRY) {
    ...
    DATA_BP.forEach((bp, level_index) => {
      ...
      const soul_augment: Augment = makeAugmentSoul(name, level, {
        [StatEnum.CORE_BP]: bp,
        [weapon_up]: weapon_up,
        [StatEnum.ADV_DEF_DAMAGE_RES]: damage_res,
      });
...
(() => {
  ...
  DATA_BP.forEach((bp, level_index) => {
    ...
    const soul_augment: Augment = makeAugmentSoul("Eradi", level, {
      [StatEnum.CORE_BP]: bp,
      [StatEnum.CORE_HP]: hp,
      [StatEnum.CORE_PP]: pp,
